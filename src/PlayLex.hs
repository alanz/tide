...
tokenA :: Parser Token
tokenA = char 'a' >> return TokenA

tokenBL :: Parser Token
tokenBL =  char 'b' >> return TokenBL

tokenBU :: Parser Token
tokenBU = char 'B' >> return TokenBU

tokenBd :: Parser Token
tokenBd = char 'd' >> return TokenBd

tokenBD :: Parser Token
tokenBD = char 'D' >> return TokenBD

tokenC :: Parser Token
tokenC = char 'c' >> return TokenC
