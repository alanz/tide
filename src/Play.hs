...
-- using template file /home/alanz/.cabal/share/x86_64-linux-ghc-8.0.2/happy-1.20.0/IncrementalTemplate-ghc-debug
...
{-# LINE 17 "templates/IncrementalTemplate.hs" #-}
...
#endif
{-# LINE 50 "templates/IncrementalTemplate.hs" #-}
...
{-# LINE 81 "templates/IncrementalTemplate.hs" #-}

{-# LINE 95 "templates/IncrementalTemplate.hs" #-}
...
{-# LINE 561 "templates/IncrementalTemplate.hs" #-}
...
{-# LINE 601 "templates/IncrementalTemplate.hs" #-}
...
happyGoto am nt j inp st =
   ...
   where off = indexShortOffAddr happyGotoOffsets st
         off_i = (off Happy_GHC_Exts.+# nt)
         new_state = indexShortOffAddr happyTable off_i
{-# LINE 765 "templates/IncrementalTemplate.hs" #-}
